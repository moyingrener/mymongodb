...
<div class="container">
    <div class="row">
        <h3>书籍录入<span class="label label-info">信息填写</span></h3>
    </div>
<%--    action="${pageContext.request.contextPath}"--%>
    <div class="row">
        <form class="form-horizontal" id="book_form" action="${pageContext.request.contextPath}/book/uploadBook" onsubmit="return formSumit()" method="post">
